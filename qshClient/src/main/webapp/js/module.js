...
//从指定参数中获取url参数
function getUrlParamFrom(sName){
	var sValue = '';
	sName = trim(sName);
	if(sName != ""){
		var re = new RegExp("\\b"+sName+"\\b=([^&=]+)");
		var sVal = getUrlParam("s");
		if(sVal!=''){
			var st = $.base64.decoded(sVal).match(re);
			if(st && st.length == 2)sValue = trim(st[1]);
		}
	}
	return sValue;
...
function getContextPath() { 
	//js获取项目根路径，如： http://localhost:8080/96fenqi
    //获取当前网址，如： http://localhost:8080/96fenqi/pad/getPadList.do
    var curWwwPath=window.document.location.href;
    //获取主机地址之后的目录，如： pad/getPadList.do
    ...
    //获取  http://localhost:8080/96fenqi
    var webroot=localhostPaht+projectName;
    return webroot;
}
...
function changeBtnState(id, btn) {
	if ($("#"+id).val()) {
...
function getBankName(bankCode){
	...
	if(bankCode =='0104'){
		bankName = 'zgyh';
	}else if(bankCode =='0103'){
		bankName = 'nyyh';
	}else if(bankCode =='0105'){
		bankName = 'jsyh';
	}else if(bankCode =='0301'){
		bankName = 'jtyh';
	}else if(bankCode =='0308'){
		bankName = 'zsyh';
	}else if(bankCode =='0403'){
		bankName = 'ycyh';
	}else if(bankCode =='0309'){
		bankName = 'xyyh';
	}else if(bankCode =='0303'){
		bankName = 'gdyh';
	}else if(bankCode =='0302'){
		bankName = 'zxyh';
	}else if(bankCode =='0304'){
		bankName = 'hxyh';
	}else if(bankCode =='0305'){
		bankName = 'msyh';
	}else if(bankCode =='0307'){
		bankName = 'payh';
	}else if(bankCode =='0310'){
		bankName = 'pfyh';
	}
	return bankName;
}
function getBankCHNName(bankCode){
    	var bankCHNName;
    	if(bankCode =='0104'){
			bankCHNName = '中国银行';
		}else if(bankCode =='0103'){
